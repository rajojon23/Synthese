function loadGame(text){
		...
		$(document).ready(function () {
				...
				var HTML_FILE_URL = '../html/level1-dictionnary.txt';
				var HTML_FILE_URL2 = '../html/level2-dictionnary.txt';
				var HTML_FILE_URL3 = '../html/level3-dictionnary.txt';
...
// -	Green: ennemi de grande taille, vitesse rapide, capacité de vol
				...
				function createEnemies(START,COUNT,BLUES,YELLOWS,GREENS){
					...
					for (var i = 0; i < YELLOWS; i++) {
						...
						en.push(currEn);	
						var currTx = new Text(0, level2Words[lastNum+i],currEn);
						tx.push(currTx);
						//setTimeout(function(){
			...
			function Enemy(x,y,name,w,h,speed,text){
				...
				this.remove = false;
				this.text = text;
				this.delay = getRandomInt(0,1000);
